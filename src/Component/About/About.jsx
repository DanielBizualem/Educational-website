  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>With a focus on innovation, hands-on learning, and personalized mentorship, our programs prepare aspiring eductors to make a 
                meaningful impact on a classrooms, schools and communities.</p>
            <p>
